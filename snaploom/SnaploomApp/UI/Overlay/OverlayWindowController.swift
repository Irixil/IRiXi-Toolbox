...
extension OverlayWindowController: OverlayViewDelegate {
    ...
    func overlayViewDidRequestDetach() {
        #if IRIXI_HELPER
        // The embedded build edits directly in the capture overlay.  Opening a
        // second editor window would reintroduce the separate-app experience
        // that this integration deliberately removes.
        return
        #else
