...
contextBridge.exposeInMainWorld('notchAPI', {
  ...
  previewSampleTool: () => ipcRenderer.invoke('tools:preview-sample'),
  installSampleTool: () => ipcRenderer.invoke('tools:install-sample'),
  setToolEnabled: (id, enabled) => ipcRenderer.invoke('tools:set-enabled', { id, enabled }),
  getToolState: (id) => ipcRenderer.invoke('tools:get-state', id),
  runToolAction: (id, actionId) => ipcRenderer.invoke('tools:run-action', { id, actionId }),
  uninstallTool: (id, keepData) => ipcRenderer.invoke('tools:uninstall', { id, keepData }),
  getNativeModuleStatus: () => ipcRenderer.invoke('native-module:status'),
  openNativeTestWindow: () => ipcRenderer.invoke('native-module:test-window-open'),
  closeNativeTestWindow: () => ipcRenderer.invoke('native-module:test-window-close'),
  startNativeAreaCapture: () => ipcRenderer.invoke('native-module:capture-area'),
  startNativeWindowCapture: () => ipcRenderer.invoke('native-module:capture-window'),
  startNativeFullscreenCapture: () => ipcRenderer.invoke('native-module:capture-fullscreen'),
  startNativeOCRCapture: () => ipcRenderer.invoke('native-module:capture-ocr'),
  startNativeImageTranslationCapture: () => ipcRenderer.invoke('native-module:capture-translate'),
  openNativeInputTranslation: (partner) => ipcRenderer.invoke('native-module:translation-input', partner),
  startNativeSelectionTranslation: () => ipcRenderer.invoke('native-module:translation-selection'),
